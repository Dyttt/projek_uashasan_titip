...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>NEXGEN Course Programming</title>
        ...
        <link rel="stylesheet" href="css/layout-rtl.min.css">
                        ...
                        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".nav-collapse">
                          ...
                          <div class="logo">
                            <a class="logo-wrap" href="#body">
                                <img class="logo-img logo-img-main" src="img/logo3.png" alt="FlameOnePage Logo">
                                <img class="logo-img logo-img-active" src="img/logo3.png" alt="FlameOnePage Dark Logo">
                            </a>
                        </div>
                    </div>
					  ...
					  <ul class="nav-lang">
                        ...
                        <div class="menu-container">
                            <ul class="nav navbar-nav navbar-nav-right">
                                ...
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="#about">Biodata</a></li>
								<li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="#services">Expertise</a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="#products">Language</a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="#pricing">Package</a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="#work">MySOSMADE</a></li>
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h1 class="carousel-title">Programming Course</h1>
                ...
                <div class="item">
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            ...
                            <a href="login.php" class="btn-theme btn-theme-sm btn-white-brd text-uppercase">Take a Course</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="masonry-grid row">
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 sm-margin-b-30">
                        <div class="margin-b-60">
                            <h2>Inna Lazimul Hasan</h2>
                          <h5>ALAMAT     : PRAYA, LOMBOK TENGAH</h5>
                          <h5>JURUSAN    : TEKNIK INFORMATIKA</h5>
                          <h5>NO. TELPON : ***236893455</h5>
                        </div>
                        <img class="full-width img-responsive wow fadeInUp" src="img/500x500/hasan1.jpeg" alt="Portfolio Image" data-wow-duration=".3" data-wow-delay=".2s">
                    </div>
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4">
                        <div class="margin-b-60">
                          <h2>Firman Maulana</h2>
                          <h5>ALAMAT     : TALIWANG, SUMBBAWA BARAT</h5>
                          <h5>JURUSAN    : TEKNIK INFORMATIKA</h5>
                          <h5>NO. TELPON : ***236893055</h5>
                        </div>
						 <img class="full-width img-responsive wow fadeInUp" src="img/500x500/firman.jpeg" alt="Portfolio Image" data-wow-duration=".3" data-wow-delay=".3s">
                    </div>
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4">
                        <div class="margin-t-60 margin-b-60">
                            <h2>Melinda</h2>
                            <h5>ALAMAT     : BODAK, KOPANGG</h5>
                            <h5>JURUSAN    : TEKNIK INFORMATIKA</h5>
                            <h5>NO. TELPON : ***236893155</h5>
                        </div>
                        <img class="full-width img-responsive wow fadeInUp" src="img/500x500/mel.jpeg" alt="Portfolio Image" data-wow-duration=".3" data-wow-delay=".4s">
                    </div>
				</div>
                <!-- End Masonry Grid -->
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 sm-margin-b-50">
                        <div class="margin-b-20">
                            <img class="img-responsive" src="img/Logo HTML5.JPG" alt="Latest Products Image">
                        </div>
                        <h4><a href="#">HTML</a> <span class="text-uppercase margin-l-20">Pondaction</span></h4>
                    ...
                    <div class="col-sm-4 sm-margin-b-50">
                        <div class="margin-b-20">
                            <img class="img-responsive" src="img/CSS 3.png" alt="Latest Products Image">
                        </div>
                        <h4><a href="#">CSS</a> <span class="text-uppercase margin-l-20">Decoration</span></h4>
                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit sed tempor incdidunt ut laboret dolor magna ut consequat siad esqudiat dolor</p>
                        <a class="link" href="#">Details</a>
                    </div>
                    <!-- End Latest Products -->
                    ...
                    <div class="col-sm-4 sm-margin-b-50">
                        <div class="margin-b-20">
                            <img class="img-responsive" src="img/js.png" alt="Latest Products Image">
                        </div>
                        <h4><a href="#">JAVASCRIPTS</a> <span class="text-uppercase margin-l-20">Animation</span></h4>
                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit sed tempor incdidunt ut laboret dolor magna ut consequat siad esqudiat dolor</p>
                        <a class="link" href="#">Details</a>
                    </div>
                    <!-- End Latest Products -->
                        ...
                        <div class="content-md container">
                            ...
                            <div class="masonry-grid row">
                                ...
                                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 md-margin-b-30">
                                    ...
                                    <div class="work work-popup-trigger">
                                        <div class="work-overlay">
                                            <img class="full-width img-responsive" src="img/logo fb.png" alt="Portfolio Image">
                                        </div>
                                        <div class="work-popup-overlay">
                                            <div class="work-popup-content">
                                                <a href="javascript:void(0);" class="work-popup-close">Hide</a>
                                                <div class="margin-b-30">
                                                    <h3 class="margin-b-5">My Sosial Media</h3>
                                ...
                                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 md-margin-b-30">
                                    ...
                                    <div class="work work-popup-trigger">
                                        <div class="work-overlay">
                                            <img class="full-width img-responsive" src="img/ig.jpg" alt="Portfolio Image">
                                        </div>
                                        <div class="work-popup-overlay">
                                            <div class="work-popup-content">
                                                <a href="javascript:void(0);" class="work-popup-close">Hide</a>
                                ...
                                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4">
                                    ...
                                    <div class="work work-popup-trigger">
                                        <div class="work-overlay">
                                            <img class="full-width img-responsive" src="img/wa.png" alt="Portfolio Image">
                                        </div>
                                        <div class="work-popup-overlay">
                                            <div class="work-popup-content">
                                                <a href="javascript:void(0);" class="work-popup-close">Hide</a>
                        ...
                        <div class="col-sm-4 sm-margin-b-2">
                            ...
                            <div class="pricing">
                                <div class="margin-b-30">
                                    ...
                                    <h3>Silver Package <span> - Rp.</span> 580.000.00</h3>
                                ...
                                <a href="pembelian.php" class="btn-theme btn-theme-sm btn-default-bg text-uppercase">Start Now</a>
                            </div>
                            <!-- End Pricing -->
                        </div>
                        <div class="col-sm-4 sm-margin-b-2">
                            ...
                            <div class="pricing pricing-active">
                                <div class="margin-b-30">
                                    ...
                                    <h3>Gold Package <span> - Rp.</span> 799.000.00</h3>
                                    <p>Lorem ipsum dolor amet consectetur ut consequat siad esqudiat dolor</p>
                                </div>
                                <ul class="list-unstyled pricing-list margin-b-50">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="pricing">
                                <div class="margin-b-30">
                                    ...
                                    <h3>Premium Package <span> - Rp.</span> 1.000.000.00</h3>
                                    <p>Lorem ipsum dolor amet consectetur ut consequat siad esqudiat dolor</p>
                                </div>
                                <ul class="list-unstyled pricing-list margin-b-50">
                    ...
                    <div class="row row-space-1 margin-b-2">
                        ...
                        <div class="col-sm-4 sm-margin-b-2">
                            <div class="service bg-color-base" data-height="height">
                                ...
                                <div class="service-info">
                                    <h3 class="color-white">Web Devloper</h3>
                    ...
                    <div class="row">
                        <div class="col-sm-2 sm-margin-b-30">
                            ...
                            <ul class="list-unstyled footer-list">
                                ...
                                <li class="footer-list-item"><a href="#about">Biodata</a></li>
                                <li class="footer-list-item"><a href="#work">Expertise</a></li>
                        ...
                        <div class="col-sm-2 sm-margin-b-30">
                            ...
                            <ul class="list-unstyled footer-list">
                                ...
                                <li class="footer-list-item"><a href="#">WhattsApp</a></li>
                            </ul>
                            <!-- End List -->
                        </div>
                        <div class="col-sm-3">
            ...
            <div class="content container">
                <div class="row">
                    ...
                    <div class="col-xs-6 text-right">
                        <p class="margin-b-0"><a class="fweight-700" href="#">flame</a> Theme Powered by: <a class="fweight-700" href="http://ft-seo.ch/">NEXGEN</a></p>
                    </div>
                </div>
                <!--// end row -->
            </div>
